...
(function () {
  ...
  // tutorial.mp3 is not shipped in this mirror; keep tutorial state silent/valid
  // by reusing menu music instead of triggering repeated 404s.
  var tutorialAudio = new Audio(soundsPath + 'menu.mp3');
  menuAudio.loop = true;
