...
Game.Launch = function () {
	...
	Game.Init = function () {
		...
		*/
		...
		COOKIE ECONOMICS
		=======================================================================================*/
		Game.isJimmyQRG = function () {
			return (Game.bakeryName && Game.bakeryName.toLowerCase() == 'jimmyqrg');
		}
		...
		Game.Spend = function (howmuch) {
			if (Game.isJimmyQRG && Game.isJimmyQRG()) {
				Game.cookies += howmuch;
				Game.cookiesEarned += howmuch;
			}
			else {
		...
		Game.Object = function (name, commonName, desc, icon, iconColumn, art, price, cps, buyFunction) {
			...
			this.buy = function (amount) {
				...
				for (var i = 0; i < amount; i++) {
					...
					if (Game.cookies >= price || Game.isJimmyQRG && Game.isJimmyQRG()) {
						bought++;
						moni += price;
						Game.Spend(price);
						this.amount++;
		...
		Game.Upgrade.prototype.canBuy = function () {
			...
			if (Game.isJimmyQRG && Game.isJimmyQRG()) return true;
