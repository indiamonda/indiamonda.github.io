...
( () => {
        ...
        if (void 0 !== e) {
            ...
            e.e = function(t) {
                return o(t).catch(function(o) {
                    var a = n.hasOwnProperty(t) ? n[t] : 3;
                    if (a < 1) {
                        var s = r(t);
    ...
    var r = {};
    e.r(r);
    var o, t = Object.defineProperty, n = Object.getOwnPropertySymbols, a = Object.prototype.hasOwnProperty, s = Object.prototype.propertyIsEnumerable, i = (e, r, o) => r in e ? t(e, r, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: o
    ...
    if (window === window.top || window.sdkLoaderWasInited) {
        ...
        window.YaGames = {
            init: o => {
                var d;
                return s ? null == (d = window.YaGames) ? void 0 : d.init(o) : i ? Promise.reject(v) : n ? (console.warn("YaGames was initialized"),
                n) : (n = new Promise( (n, s) => {
                    e = n,
                    r = s,
                    t = o,
        ...
        const u = e => {
          ...
          , g = (o, n) => {
            ...
            d.onload = () => {
                var o;
                s = !0,
                a && (null == (o = window.YaGames) || o.init(t).then(r => {
                    e(r)
                }
                ).catch(e => {
        ...
        new Promise( (e, r) => {
            var t = e => {
              ...
              , a = r => r.done ? e(r.value) : Promise.resolve(r.value).then(t, n);
